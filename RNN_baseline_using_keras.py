...
# DATASET_ROOT =  os.path.join(os.getcwd(),"SpeakerRecognition-master/ml/16000_pcm_speeches")

DATASET_ROOT = "SpeakerRecognition-master/ml/16000_pcm_speeches"

# print(os.listdir(DATASET_ROOT))
# print("*"*12, os.getcwd(), DATASET_ROOT)
